...
Quark 真机版默认不画 2D 决策边界,因为那需要为 grid^2 * n_train 个点重新
提交硬件量子核任务。这里保持 task 08 为纯经典可视化,避免任何本地量子模拟器。
"""
...
def main() -> int:
    ...
    print("  decision boundary skipped: Quark hardware version avoids grid quantum jobs")
    return 0
