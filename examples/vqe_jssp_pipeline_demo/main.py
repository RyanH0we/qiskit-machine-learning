...
FIG_QUBO = FIGURES_DIR / "02_qubo_matrix.png"
FIG_REFERENCE = FIGURES_DIR / "03_reference_gantt.png"
...
FIG_VQE_GANTT = FIGURES_DIR / "08_vqe_gantt.png"
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--horizon", type=int, default=5, help="JSSP 离散时间上界")
    p.add_argument("--penalty", type=float, default=10.0, help="QUBO 约束惩罚权重")
...
def main() -> int:
    ...
    print_banner(TaskKind.CLASSICAL, "VQE-JSSP pipeline 启动")
    print(f"  artifacts = {ARTIFACTS_DIR}")
    print(f"  python    = {sys.executable}")
    print(
        "  config    = "
        f"horizon={args.horizon}, penalty={args.penalty}, ansatz_reps={args.ansatz_reps}, "
    ...
    print_banner(TaskKind.CLASSICAL, "VQE-JSSP pipeline 完成")
